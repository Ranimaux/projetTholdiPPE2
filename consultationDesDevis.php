...
<div class="row">
    <div class="col-3">
        <?php include_once '_menuDevis.inc.php'; ?>
    </div>
    <div class="col-1"></div>
            ...
            <div class="col ">
                ...
                <div>
                    <a class="infobulle">
                        ...
                        <span>Ci-dessous, vous pouvez consulter sous forme de liste, tous vos Devis à votre nom et ainsi les valider ou non</span>
                    </a>
                </div>
                <div class="mb-3">
                    ...
                    <span class="font-monospace"> VOS DEVIS </span>
    ...
    if (count($collectionDeReservations) > 0):
        ...
        foreach ($collectionDeReservations as $uneReservation) :
            ?>
            <?php
            $_SESSION["codeReservation"] = $uneReservation["codeReservation"];
            $codeReservation = $_SESSION["codeReservation"];
            ?>
            <?php
            if (devisExistePourUneReservationPourUnClient($codeUtilisateur, $codeReservation) != false) :
                ?>
                <?php
                $unDevis = obtenirDetailDeUnDevisPourUnClient($codeUtilisateur, $codeReservation);
                ...
                <div class="col-7 offset-4 shadow mt-3 ">
                    <div class="card m-4 ">
                        <div class="card-header text-center alert-success " >
                            date création du devis : <?php echo dateAuFormatJourMoisAnnee($unDevis["dateDevis"]); ?>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                            ...
                            <div class="row mt-3 mb-2">
                                <div class="col">
                                    ...
                                    <span class="fw-bold ">
                                        <?php
                                        echo $unDevis["nbContainers"];
                                        ?>
                                    </span>
                                    Volume estim&eacute; :
                                    <span class="fw-bold ">
                                        <?php
                                        echo ($unDevis["volume"]) ? $unDevis["volume"] : "<i>Non renseigné</i>";
                                        ?>
                                </div>
                            </div>
                                            ...
                                            <input type="hidden" name="codeReservation" 
                                                   value="<?php echo $uneReservation["codeReservation"] ?>">
                                                       ...
                                                       switch ($uneReservation["etat"]) :
                                                        ...
                                                        <button type="submit" class="btn btn-primary w-75" >PDF du Devis</button>
                                                        <?php
                                                        break;
