                ...
                <div class="col">
                    ...
                    <div class="row mb-3">
                        <div class="form-group  col-md-4">
                            ...
                            <select class="form-control" id="villeDepart" name="villeDepart" placeholder="ville de départ">
                                <?php
                                $listeVille = obtenirLaCollectionDesVilles(); //fonction pour obtenir la liste des villes
